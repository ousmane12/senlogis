...
import { Appartment } from '../../dashboard/model/appartment';
import { AppartmentService } from '../../dashboard/service/appartment.service';
import { ImageProcessingService } from '../../dashboard/service/image-processing.service';
...
export class SingleV1Component implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private modalService: NgbModal, private formBuilder: UntypedFormBuilder, private _lightbox: Lightbox, 
    private appartmentService: AppartmentService,
    private imageProcesingService: ImageProcessingService) {

      const idBuilding: number = +this.route.snapshot.paramMap.get('id')!;
      
        this.appartmentService.getAppartment(idBuilding).subscribe(app => {
          this.appartment = 
            this.imageProcesingService.createImages(app)
        });
 ...
 */
  ...
  customOpen(a: any): void {
    // open lightbox
    this._lightbox.open(this.appartment.images, a);
  }
