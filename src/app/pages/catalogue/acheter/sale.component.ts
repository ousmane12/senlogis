...
export class SaleComponent implements OnInit {
 ...
 constructor(public router: Router, private appartmentService: AppartmentService,
 ...
 ngOnInit(): void {
    ...
    * BreadCrumb
    */
   this.appartmentService.findAll().subscribe(app => {
    this.filteredAppartments = app.filter((user) => user.idLocataire == null);
    this.appartments = this.filteredAppartments.map(appartment =>
      this.imageProcesingService.createImages(appartment)
    );
  });
    this.breadCrumbItems = [
     { label: 'Propriétés', link:'' },
     { label: 'A vendre', active: true }
   ];
